...
class StoreChildrenRequest extends FormRequest
{
    ...
    {
        return [
            'identity_number' => 'nullable|string|size:16|unique:childrens,identity_number',
    ...
    public function messages(): array
    {
        return [
            ...
            'mother_id.required' => 'The mother ID field is required.',
            'mother_id.exists' => 'The mother ID field must exist.',
