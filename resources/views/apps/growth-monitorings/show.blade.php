    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-base text-gray-500">Tanggal: {{ $growthMonitoring->checkup_date->format('d F Y') }}</p>
            </div>
        </div>
        ...
        <div class="flex items-center space-x-3">
            @if(Auth::user()->staff && Auth::user()->staff->role === 'ketua-kader' && $growthMonitoring->child->mother->phone_number)
                ...
                @endphp
                <a href="{{ $waUrl }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent text-white text-base font-medium rounded-lg hover:bg-green-700 transition-colors shadow-sm">
            ...
            @endif
            <a href="{{ route('growth-monitorings.edit', $growthMonitoring) }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-200 text-gray-700 text-base font-medium rounded-lg hover:bg-gray-50 transition-colors shadow-sm">
            ...
            <div class="p-6">
                <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-6">
                     <div class="sm:col-span-1">
                        <dt class="text-base font-medium text-gray-500">Nama Anak</dt>
                     ...
                     <div class="sm:col-span-1">
                        ...
                        <dd class="mt-1 text-base text-gray-900">{{ $growthMonitoring->staff->user->name }}</dd>
                    </div>
                    <div class="sm:col-span-1">
                        <dt class="text-base font-medium text-gray-500">Berat Badan</dt>
                        <dd class="mt-1 text-2xl font-bold text-gray-900">{{ $growthMonitoring->weight }} <span class="text-base font-normal text-gray-500">kg</span></dd>
                    </div>
                     <div class="sm:col-span-1">
                        <dt class="text-base font-medium text-gray-500">Tinggi Badan</dt>
                        <dd class="mt-1 text-2xl font-bold text-gray-900">{{ $growthMonitoring->height }} <span class="text-base font-normal text-gray-500">cm</span></dd>
                    </div>
                     <div class="sm:col-span-1">
                        <dt class="text-base font-medium text-gray-500">Status Gizi</dt>
                        <dd class="mt-1">
                             <span class="px-2.5 py-1 rounded-full text-base font-medium inline-block
                    ...
                    <div class="sm:col-span-1">
                        <dt class="text-base font-medium text-gray-500">Z-Score</dt>
                        <dd class="mt-1 text-base text-gray-900 font-mono">{{ $growthMonitoring->z_score }} SD</dd>
                    </div>
                     <div class="sm:col-span-2">
                        <dt class="text-base font-medium text-gray-500">Catatan</dt>
                        <dd class="mt-1 text-base text-gray-900 bg-gray-50 p-3 rounded-lg border border-gray-100">{{ $growthMonitoring->note ?? '-' }}</dd>
                    </div>
                </dl>
            </div>
        </div>
