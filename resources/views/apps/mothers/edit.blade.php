    ...
    <div class="bg-white rounded-xl shadow-[0_0_20px_rgba(0,0,0,0.05)] border border-gray-100 overflow-hidden">
        ...
        <form action="{{ route('mothers.update', $mother) }}" method="POST" class="p-6 space-y-8" autocomplete="off">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $mother->name) }}" required
                    ...
                    <!-- Husband Name Field -->
                    <div class="w-full">
                        <label for="husband_name" class="block text-base font-medium text-gray-700 mb-1">Nama Suami</label>
                        <input type="text" name="husband_name" id="husband_name" value="{{ old('husband_name', $mother->husband_name) }}"
                    ...
                    <div class="w-full">
                        <label for="identity_number" class="block text-base font-medium text-gray-700 mb-1">NIK <span class="text-red-500">*</span></label>
                        <input type="text" name="identity_number" id="identity_number" value="{{ old('identity_number', $mother->identity_number) }}" required
                    ...
                    <!-- Phone Number Field -->
                    <div class="w-full">
                        <label for="phone_number" class="block text-base font-medium text-gray-700 mb-1">Nomor Telepon <span class="text-red-500">*</span></label>
                        <input type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $mother->phone_number) }}" required
                    ...
                    <div class="w-full">
                     ...
                     <!-- Birth Place Field -->
                    <div class="w-full">
                        <label for="birth_place" class="block text-base font-medium text-gray-700 mb-1">Tempat Lahir <span class="text-red-500">*</span></label>
                        <input type="text" name="birth_place" id="birth_place" value="{{ old('birth_place', $mother->birth_place) }}" required
                    ...
                    <!-- Birth Date Field -->
                    <div class="w-full">
                        <label for="birth_date" class="block text-base font-medium text-gray-700 mb-1">Tanggal Lahir <span class="text-red-500">*</span></label>
                        <input type="date" name="birth_date" id="birth_date" value="{{ old('birth_date', $mother->birth_date->format('Y-m-d')) }}" required
                    ...
                    <!-- Blood Type Field -->
                    <div class="w-full">
                        <label for="blood_type" class="block text-base font-medium text-gray-700 mb-1">Golongan Darah <span class="text-red-500">*</span></label>
                        <select name="blood_type" id="blood_type" required
                            ...
                            @foreach(['A', 'B', 'AB', 'O'] as $blood)
                                <option value="{{ $blood }}" {{ old('blood_type', $mother->blood_type) == $blood ? 'selected' : '' }}>{{ $blood }}</option>
                            @endforeach
                        </select>
                        @error('blood_type')
                            <p class="mt-1 text-base text-red-600">{{ $message }}</p>
                    ...
                    <div class="w-full">
                        ...
                        <input type="number" step="0.1" name="height" id="height" value="{{ old('height', $mother->height) }}" required
                    ...
                    <div class="w-full">
                        <label for="weight" class="block text-base font-medium text-gray-700 mb-1">Berat Badan Awal (kg) <span class="text-red-500">*</span></label>
                        <input type="number" step="0.1" name="weight" id="weight" value="{{ old('weight', $mother->weight) }}" required
                    ...
                    <div class="w-full md:col-span-2">
                        <label for="address" class="block text-base font-medium text-gray-700 mb-1">Alamat Lengkap <span class="text-red-500">*</span></label>
                        <textarea name="address" id="address" rows="3" required
                            ...
                            placeholder="Alamat domisili lengkap...">{{ old('address', $mother->address) }}</textarea>
                         @error('address')
                            <p class="mt-1 text-base text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-100">
                <a href="{{ route('mothers.index') }}" class="px-4 py-2 bg-white border border-gray-200 text-gray-700 text-base font-medium rounded-lg hover:bg-gray-50 transition-colors">
                    Batal
                </a>
