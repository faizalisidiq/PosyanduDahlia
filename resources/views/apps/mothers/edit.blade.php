...
@section('content')
    <div class="w-full mx-auto space-y-6">
        <!-- Breadcrumb -->
        <x-breadcrumb :items="[['label' => 'Data Ibu', 'url' => route('mothers.index')], ['label' => 'Ubah Data']]" />
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $mother->name) }}"
                                required
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="identity_number" id="identity_number"
                                value="{{ old('identity_number', $mother->identity_number) }}" required
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="phone_number" id="phone_number"
                                value="{{ old('phone_number', $mother->phone_number) }}" required
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="social_security_number" id="social_security_number"
                                value="{{ old('social_security_number', $mother->social_security_number) }}"
                        ...
                        <div class="w-full">
                            ...
                            <select name="health_facility" id="health_facility"
                                ...
                                <option value="Klinik"
                                    {{ old('health_facility', $mother->health_facility) == 'Klinik' ? 'selected' : '' }}>
                                    Klinik</option>
                                <option value="Puskesmas"
                                    {{ old('health_facility', $mother->health_facility) == 'Puskesmas' ? 'selected' : '' }}>
                                    Puskesmas</option>
                                <option value="RS"
                                    {{ old('health_facility', $mother->health_facility) == 'RS' ? 'selected' : '' }}>RS
                                </option>
                            </select>
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="birth_place" id="birth_place"
                                value="{{ old('birth_place', $mother->birth_place) }}" required
                        ...
                        <div class="w-full">
                            ...
                            <input type="date" name="birth_date" id="birth_date"
                                value="{{ old('birth_date', $mother->birth_date->format('Y-m-d')) }}" required
                        ...
                        <div class="w-full">
                            ...
                            <select name="blood_type" id="blood_type" required
                                ...
                                @foreach (['A', 'B', 'AB', 'O'] as $blood)
                                    <option value="{{ $blood }}"
                                        {{ old('blood_type', $mother->blood_type) == $blood ? 'selected' : '' }}>
                                        {{ $blood }}</option>
                                @endforeach
                            </select>
                            @error('blood_type')
                        ...
                        <div class="w-full">
                            ...
                            <input type="number" step="0.1" name="height" id="height"
                                value="{{ old('height', $mother->height) }}" required
                        ...
                        <div class="w-full">
                            ...
                            <input type="number" step="0.1" name="weight" id="weight"
                                value="{{ old('weight', $mother->weight) }}" required
                        ...
                        <div class="w-full">
                            ...
                            <select name="status" id="status" required
                                ...
                                <option value="hamil" {{ old('status', $mother->status) == 'hamil' ? 'selected' : '' }}>
                                    Hamil</option>
                                <option value="menyusui"
                                    {{ old('status', $mother->status) == 'menyusui' ? 'selected' : '' }}>Menyusui</option>
                                <option value="lainnya"
                                    {{ old('status', $mother->status) == 'lainnya' ? 'selected' : '' }}>Anak > 2 Tahun
                                </option>
                            </select>
                            @error('status')
                                <p class="mt-1 text-base text-red-600">{{ $message }}</p>
