        ...
        <form action="{{ route('childrens.update', $children) }}" method="POST" class="p-6 space-y-8" autocomplete="off">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="w-full">
                        <label for="identity_number" class="block text-base font-medium text-gray-700 mb-1">NIK Anak <span class="text-sm text-gray-500">(Opsional)</span></label>
                    ...
                    <div class="w-full">
                        <label for="mother_id" class="block text-base font-medium text-gray-700 mb-1">Nama Ibu</label>
                         <select name="mother_id" id="mother_id" disabled
                            class="block w-full rounded-lg border-gray-200 bg-gray-100 text-gray-500 cursor-not-allowed shadow-sm sm:text-base p-2.5">
                            <option value="{{ $children->mother_id }}" selected>{{ $children->mother->name }}</option>
                        </select>
                         <p class="text-sm text-gray-500 mt-1">Data ibu tidak dapat diubah dari menu ini.</p>
                    </div>

                    <!-- Gender Field -->
                    <div class="w-full">
                        <label for="gender" class="block text-base font-medium text-gray-700 mb-1">Jenis Kelamin <span class="text-red-500">*</span></label>
                    ...
                    <div class="w-full">
                     ...
                     <!-- Birth Weight Field -->
                    <div class="w-full">
                        <label for="birth_weight" class="block text-base font-medium text-gray-700 mb-1">Berat Lahir (kg) <span class="text-red-500">*</span></label>
                     ...
                     <!-- Birth Height Field -->
                    <div class="w-full">
                        <label for="birth_height" class="block text-base font-medium text-gray-700 mb-1">Tinggi Lahir (cm) <span class="text-red-500">*</span></label>
                    ...
                    <!-- BPJS Facility Field -->
                    <div class="w-full">
                        <label for="bpjs_facility" class="block text-base font-medium text-gray-700 mb-1">Faskes (BPJS) <span class="text-sm text-gray-500">(Opsional)</span></label>
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-100">
                <a href="{{ route('childrens.index') }}" class="px-4 py-2 bg-white border border-gray-200 text-gray-700 text-base font-medium rounded-lg hover:bg-gray-50 transition-colors">
                    Batal
                </a>
