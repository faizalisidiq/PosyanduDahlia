...
@section('content')
    <div class="w-full mx-auto space-y-6">
        <!-- Breadcrumb -->
        <x-breadcrumb :items="[['label' => 'Data Anak', 'url' => route('childrens.index')], ['label' => 'Ubah Data']]" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="identity_number" id="identity_number"
                                value="{{ old('identity_number', $children->identity_number) }}"
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $children->name) }}"
                                required
                        ...
                        <div class="w-full">
                            ...
                            <select name="gender" id="gender" required
                                ...
                                <option value="male" {{ old('gender', $children->gender) == 'male' ? 'selected' : '' }}>
                                    Laki-laki</option>
                                <option value="female" {{ old('gender', $children->gender) == 'female' ? 'selected' : '' }}>
                                    Perempuan</option>
                            </select>
                            @error('gender')
                                <p class="mt-1 text-base text-red-600">{{ $message }}</p>
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="birth_place" id="birth_place"
                                value="{{ old('birth_place', $children->birth_place) }}" required
                        ...
                        <div class="w-full">
                            ...
                            <input type="date" name="birth_date" id="birth_date"
                                value="{{ old('birth_date', $children->birth_date->format('Y-m-d')) }}" required
                        ...
                        <div class="w-full">
                            ...
                            <select name="bpjs_facility" id="bpjs_facility"
                                ...
                                <option value="Klinik"
                                    {{ old('bpjs_facility', $children->bpjs_facility) == 'Klinik' ? 'selected' : '' }}>
                                    Klinik</option>
                                <option value="Puskesmas"
                                    {{ old('bpjs_facility', $children->bpjs_facility) == 'Puskesmas' ? 'selected' : '' }}>
                                    Puskesmas</option>
                                <option value="RS"
                                    {{ old('bpjs_facility', $children->bpjs_facility) == 'RS' ? 'selected' : '' }}>RS
                                </option>
                            </select>
                            @error('bpjs_facility')
                                <p class="mt-1 text-base text-red-600">{{ $message }}</p>
