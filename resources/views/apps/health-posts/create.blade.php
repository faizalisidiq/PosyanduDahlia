...
<div class="w-full mx-auto space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-[0_0_20px_rgba(0,0,0,0.05)] border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100">
            <h2 class="text-lg font-bold text-gray-800">Form Tambah Posyandu</h2>
            <p class="text-base text-gray-500">Silakan isi informasi lengkap mengenai posyandu baru.</p>
        </div>
        
        <form action="{{ route('health-posts.store') }}" method="POST" class="p-6 space-y-6" autocomplete="off">
            @csrf

            <!-- Name Field -->
            <div class="w-full">
                <label for="name" class="block text-base font-medium text-gray-700 mb-1">Nama Posyandu <span class="text-red-500">*</span></label>
            ...
            <!-- Phone Field -->
            <div class="w-full">
                <label for="phone" class="block text-base font-medium text-gray-700 mb-1">Nomor Telepon / Kontak</label>
            ...
            <div class="w-full">
                ...
                <textarea name="address" id="address" rows="3"
                    ...
                    placeholder="Tuliskan alamat lengkap posyandu disini...">{{ old('address') }}</textarea>
                @error('address')
                    <p class="mt-1 text-base text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-100">
                <a href="{{ route('health-posts.index') }}" class="px-4 py-2 bg-white border border-gray-200 text-gray-700 text-base font-medium rounded-lg hover:bg-gray-50 transition-colors">
                    Batal
                </a>
