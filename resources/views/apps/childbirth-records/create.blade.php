    ...
    <div class="w-full mx-auto space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-[0_0_20px_rgba(0,0,0,0.05)] border border-gray-100 overflow-hidden">
            <div class="p-6 border-b border-gray-100">
                ...
                <p class="text-base text-gray-500">Catat informasi persalinan ibu hamil.</p>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="w-full">
                            ...
                            @if(isset($preselectedMotherId) && $preselectedMotherId)
                                <input type="hidden" name="mother_id" value="{{ $preselectedMotherId }}">
                                <select id="mother_id" disabled
                                    ...
                                    @foreach($mothers as $mother)
                                        @if($preselectedMotherId == $mother->id)
                        ...
                        <!-- Staff Field -->
                        <div class="w-full">
                            <label for="staff_id" class="block text-base font-medium text-gray-700 mb-1">Petugas Penolong
                        ...
                        <!-- Child Order -->
                        <div class="w-full">
                            <label for="child_order" class="block text-base font-medium text-gray-700 mb-1">Anak Ke- <span
                                    class="text-red-500">*</span></label>
                            <input type="number" name="child_order" id="child_order" value="{{ old('child_order', 1) }}"
                                min="1" required
                                class="block w-full rounded-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-teal-500 focus:ring-teal-500 shadow-sm sm:text-base p-2.5 transition-all @error('child_order') border-red-500 bg-red-50 @enderror"
                        ...
                        <!-- Delivery Method -->
                        <div class="w-full">
                            <label for="delivery_method" class="block text-base font-medium text-gray-700 mb-1">Metode
                                Persalinan <span class="text-red-500">*</span></label>
                            <select name="delivery_method" id="delivery_method" required
                                class="block w-full rounded-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-teal-500 focus:ring-teal-500 shadow-sm sm:text-base p-2.5 transition-all @error('delivery_method') border-red-500 bg-red-50 @enderror">
                        ...
                        <!-- Delivery Date -->
                        <div class="w-full">
                            <label for="delivery_date" class="block text-base font-medium text-gray-700 mb-1">Tanggal
                                Persalinan <span class="text-red-500">*</span></label>
                            <input type="date" name="delivery_date" id="delivery_date"
                                value="{{ old('delivery_date', date('Y-m-d')) }}" required
                                class="block w-full rounded-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-teal-500 focus:ring-teal-500 shadow-sm sm:text-base p-2.5 transition-all @error('delivery_date') border-red-500 bg-red-50 @enderror">
                            @error('delivery_date')
                                <p class="mt-1 text-base text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Delivery Location -->
                        <div class="w-full">
                            <label for="delivery_location" class="block text-base font-medium text-gray-700 mb-1">Tempat
                                Persalinan <span class="text-red-500">*</span></label>
                            <input type="text" name="delivery_location" id="delivery_location"
                                value="{{ old('delivery_location') }}" required
                                class="block w-full rounded-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-teal-500 focus:ring-teal-500 shadow-sm sm:text-base p-2.5 transition-all @error('delivery_location') border-red-500 bg-red-50 @enderror"
                        ...
                        <div class="w-full md:col-span-2 pt-4 border-t border-gray-100">
                            <h4 class="text-base font-medium text-gray-800 mb-4">Informasi Bayi Baru Lahir</h4>
                        </div>

                        <!-- Child NIK -->
                        <div class="w-full">
                            <label for="child_identity_number" class="block text-base font-medium text-gray-700 mb-1">NIK Bayi
                            ...
                            <input type="text" name="child_identity_number" id="child_identity_number"
                                ...
                                class="block w-full rounded-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-teal-500 focus:ring-teal-500 shadow-sm sm:text-base p-2.5 transition-all @error('child_identity_number') border-red-500 bg-red-50 @enderror"
                        ...
                        <!-- Child Name -->
                        <div class="w-full">
                            <label for="child_name" class="block text-base font-medium text-gray-700 mb-1">Nama Bayi <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="child_name" id="child_name" value="{{ old('child_name') }}"
                                required
                                class="block w-full rounded-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-teal-500 focus:ring-teal-500 shadow-sm sm:text-base p-2.5 transition-all @error('child_name') border-red-500 bg-red-50 @enderror"
                        ...
                        <!-- Birth Height -->
                        <div class="w-full">
                            <label for="birth_height" class="block text-base font-medium text-gray-700 mb-1">Panjang Lahir
                        ...
                        <div class="w-full md:col-span-2">
                            <label for="baby_condition" class="block text-base font-medium text-gray-700 mb-1">Kondisi Bayi
                                <span class="text-red-500">*</span></label>
                            <input type="text" name="baby_condition" id="baby_condition"
                                value="{{ old('baby_condition') }}" required
                                class="block w-full rounded-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-teal-500 focus:ring-teal-500 shadow-sm sm:text-base p-2.5 transition-all @error('baby_condition') border-red-500 bg-red-50 @enderror"
