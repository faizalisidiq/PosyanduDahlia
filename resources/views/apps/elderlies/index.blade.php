    ...
    <div class="w-full space-y-6">
        <div class="flex flex-col md:flex-row md:items-center justify-end gap-4">
            <div class="md:text-right">
                <p class="text-lg text-black font-semibold">Kelola data lansia yang terdaftar di posyandu.</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-[0_0_20px_rgba(0,0,0,0.03)] border border-gray-100 overflow-hidden">
            <div class="p-5 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div class="relative w-full max-w-lg">
                    <form action="{{ route('elderlies.index') }}" method="GET" class="flex gap-2">
                            ...
                            <tr class="hover:bg-gray-50/80 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right whitespace-nowrap">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="{{ route('elderlies.show', $elderly) }}"
                                        ...
                                        <form action="{{ route('elderlies.destroy', $elderly) }}" method="POST"
            ...
            @if($elderlies->hasPages())
                <div class="px-6 py-4 border-t border-gray-100 bg-gray-50/50">
                    {{ $elderlies->withQueryString()->links() }}
                </div>
            @endif
        </div>
    </div>
