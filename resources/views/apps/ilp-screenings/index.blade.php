            ...
            <div class="p-5 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div class="flex flex-col md:flex-row gap-2 w-full md:w-auto">
                    <button type="button" @click="exportModal = true"
                        class="inline-flex items-center justify-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-base font-medium rounded-lg shadow-sm transition-all focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 flex-shrink-0 w-full md:w-auto">
                        ...
                        <form action="{{ route('ilp-screenings.export') }}" method="GET" @submit="exportModal = false">
                            <div class="bg-white px-6 pt-6 pb-4">
                                <div class="flex items-center gap-4 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-base text-gray-500">Berdasarkan tanggal pemeriksaan.</p>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-4">
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            <label class="block text-sm font-bold text-gray-700 uppercase mb-1">Dari
                                                Tanggal</label>
                                            <input type="date" name="start_date"
                                                class="block w-full border border-gray-200 rounded-lg text-base bg-gray-50 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 p-2.5 transition-all outline-none">
                                        </div>
                                        <div>
                                            <label class="block text-sm font-bold text-gray-700 uppercase mb-1">Sampai
                                                Tanggal</label>
                            ...
                            <div class="bg-gray-50 px-6 py-4 flex flex-col-reverse sm:flex-row justify-end gap-2">
                                <button type="button" @click="exportModal = false"
                                    class="inline-flex justify-center rounded-lg border border-gray-300 px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-100 transition-colors">
                                    Batal
                                </button>
                                <button type="submit"
                                    class="inline-flex justify-center rounded-lg border border-transparent px-4 py-2 bg-emerald-600 text-base font-medium text-white hover:bg-emerald-700 transition-colors shadow-sm">
                                    Download Excel
                                </button>
                            </div>
                        </form>
                            ...
                            <tr class="hover:bg-gray-50/80 transition-colors">
                                ...
                                <td class="px-6 py-4 text-gray-600 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div
                                            class="h-6 w-6 rounded-full bg-gray-200 flex items-center justify-center text-sm font-bold text-gray-600 mr-2">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                                    <div class="flex flex-col items-center justify-center max-w-xs mx-auto">
                                        ...
                                        <h3 class="text-gray-900 font-medium text-base mb-1">Belum ada data screening</h3>
                                        <p class="text-sm text-gray-500 mb-4">Silakan tambahkan data screening baru.</p>
                                        <a href="{{ route('ilp-screenings.create') }}"
