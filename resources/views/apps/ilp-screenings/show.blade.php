        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-base text-gray-500">Tanggal:
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="p-6">
                    <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-6">
                        <div class="sm:col-span-1">
                            <dt class="text-base font-medium text-gray-500">Nama Pasien</dt>
                        ...
                        <div class="sm:col-span-1">
                            <dt class="text-base font-medium text-gray-500">Usia Saat Pemeriksaan</dt>
                            <dd class="mt-1 text-base text-gray-900 font-semibold">
                                @php
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <dd class="mt-1 text-base text-gray-900">{{ $ilpScreening->staff->user->name ?? '-' }}</dd>
                        </div>
                    </dl>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-[0_0_20px_rgba(0,0,0,0.05)] border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-6">
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-semibold text-gray-500 uppercase tracking-wider">Berat Badan</dt>
                            <dd class="mt-1 text-lg font-medium text-gray-900">{{ $results['weight'] ?? '-' }} kg</dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-semibold text-gray-500 uppercase tracking-wider">Tinggi Badan</dt>
                            <dd class="mt-1 text-lg font-medium text-gray-900">{{ $results['height'] ?? '-' }} cm</dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-semibold text-gray-500 uppercase tracking-wider">Tekanan Darah</dt>
                            <dd class="mt-1 text-lg font-medium text-gray-900">{{ $results['blood_pressure'] ?? '-' }} mmHg
                            </dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-semibold text-gray-500 uppercase tracking-wider">Gula Darah</dt>
                            <dd class="mt-1 text-lg font-medium text-gray-900">{{ $results['blood_sugar'] ?? '-' }} mg/dL
                            </dd>
                        </div>
                        <div class="sm:col-span-2">
                            <dt class="text-sm font-semibold text-gray-500 uppercase tracking-wider">Catatan / Diagnosis
                            </dt>
                            <dd
                                class="mt-2 text-base text-gray-700 bg-gray-50 p-3 rounded-lg border border-gray-100 whitespace-pre-line">
