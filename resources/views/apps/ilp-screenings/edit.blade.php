...
<div class="w-full mx-auto space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-[0_0_20px_rgba(0,0,0,0.05)] border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100">
            ...
            <p class="text-sm text-gray-500">Perbarui hasil screening kesehatan Integrasi Layanan Primer.</p>
        </div>
        ...
        <form action="{{ route('ilp-screenings.update', $ilpScreening) }}" method="POST" class="p-6 space-y-8" autocomplete="off">
            ...
            <div class="space-y-4">
                <h3 class="text-sm font-semibold text-teal-700 uppercase tracking-wider border-b border-gray-100 pb-2">Data Pasien</h3>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Subject Type (Read Only for Edit typically, or allow change but complex) -> Let's keep it editable but logic same as create -->
                    <div class="w-full">
                        <label for="subjectable_type" class="block text-sm font-medium text-gray-700 mb-1">Tipe Pasien <span class="text-red-500">*</span></label>
                        <select name="subjectable_type" id="subjectable_type" required onchange="toggleSubjectList()"
                            ...
                            <option value="App\Models\Mother" {{ old('subjectable_type', $ilpScreening->subjectable_type) == 'App\Models\Mother' ? 'selected' : '' }}>Ibu</option>
                            <option value="App\Models\Children" {{ old('subjectable_type', $ilpScreening->subjectable_type) == 'App\Models\Children' ? 'selected' : '' }}>Anak</option>
                        </select>
                    ...
                    <!-- Subject ID -->
                    <div class="w-full">
                        <label for="subjectable_id" class="block text-sm font-medium text-gray-700 mb-1">Nama Pasien <span class="text-red-500">*</span></label>
                        
                        <!-- Mothers List -->
                        <select name="subjectable_id" id="mother_list" class="hidden w-full rounded-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-teal-500 focus:ring-teal-500 shadow-sm sm:text-sm p-2.5 transition-all">
                            <option value="">Pilih Ibu...</option>
                            @foreach($mothers as $mother)
                                <option value="{{ $mother->id }}" {{ old('subjectable_id', $ilpScreening->subjectable_id) == $mother->id && old('subjectable_type', $ilpScreening->subjectable_type) == 'App\Models\Mother' ? 'selected' : '' }}>{{ $mother->name }} (NIK: {{ $mother->identity_number }})</option>
                            @endforeach
                        </select>

                        <!-- Children List -->
                        <select name="subjectable_id" id="children_list" class="hidden w-full rounded-lg border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-teal-500 focus:ring-teal-500 shadow-sm sm:text-sm p-2.5 transition-all">
                            <option value="">Pilih Anak...</option>
                            @foreach($childrens as $child)
                                <option value="{{ $child->id }}" {{ old('subjectable_id', $ilpScreening->subjectable_id) == $child->id && old('subjectable_type', $ilpScreening->subjectable_type) == 'App\Models\Children' ? 'selected' : '' }}>{{ $child->name }} (Ibu: {{ $child->mother->name }})</option>
                            @endforeach
                        </select>
                    ...
                    <!-- Checkup Date -->
                    <div class="w-full">
                        <label for="checkup_date" class="block text-sm font-medium text-gray-700 mb-1">Tanggal Pemeriksaan <span class="text-red-500">*</span></label>
            ...
            @endphp
            <div class="space-y-4">
                <h3 class="text-sm font-semibold text-teal-700 uppercase tracking-wider border-b border-gray-100 pb-2">Hasil Screening</h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <!-- Weight -->
                    <div class="w-full">
                        <label for="results_weight" class="block text-sm font-medium text-gray-700 mb-1">Berat Badan (kg)</label>
                    ...
                    <!-- Height -->
                    <div class="w-full">
                        <label for="results_height" class="block text-sm font-medium text-gray-700 mb-1">Tinggi Badan (cm)</label>
                    ...
                    <!-- Waist -->
                    <div class="w-full">
                        <label for="results_waist" class="block text-sm font-medium text-gray-700 mb-1">Lingkar Perut (cm)</label>
                    ...
                    <!-- Blood Pressure -->
                    <div class="w-full">
                        <label for="results_blood_pressure" class="block text-sm font-medium text-gray-700 mb-1">Tekanan Darah (mmHg)</label>
                    ...
                    <!-- Blood Sugar -->
                    <div class="w-full">
                        <label for="results_blood_sugar" class="block text-sm font-medium text-gray-700 mb-1">Gula Darah (mg/dL)</label>
                    ...
                    <!-- Uric Acid -->
                    <div class="w-full">
                        <label for="results_uric_acid" class="block text-sm font-medium text-gray-700 mb-1">Asam Urat (mg/dL)</label>
                    ...
                    <!-- Cholesterol -->
                    <div class="w-full">
                        <label for="results_cholesterol" class="block text-sm font-medium text-gray-700 mb-1">Kolesterol (mg/dL)</label>
                    ...
                    <!-- Eyes -->
                    <div class="w-full">
                        <label for="results_eyes" class="block text-sm font-medium text-gray-700 mb-1">Pemeriksaan Mata</label>
                    ...
                    <!-- Ears -->
                    <div class="w-full">
                        <label for="results_ears" class="block text-sm font-medium text-gray-700 mb-1">Pemeriksaan Telinga</label>
                    ...
                    <div class="w-full md:col-span-3">
                        <label for="results_note" class="block text-sm font-medium text-gray-700 mb-1">Catatan Tambahan / Diagnosis</label>
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-100">
                <a href="{{ route('ilp-screenings.index') }}" class="px-4 py-2 bg-white border border-gray-200 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 transition-colors">
                    Batal
                </a>
