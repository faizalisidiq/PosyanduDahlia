...
<div class="w-full mx-auto space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-[0_0_20px_rgba(0,0,0,0.05)] border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100">
            ...
            <p class="text-sm text-gray-500">Perbarui data pemeriksaan.</p>
        </div>
                    ...
                    <div class="w-full">
                        ...
                        <select name="mother_id" id="mother_id" required
                            ...
                            @foreach($mothers as $mother)
                                <option value="{{ $mother->id }}" {{ old('mother_id', $pregnancyRecord->mother_id) == $mother->id ? 'selected' : '' }}>{{ $mother->name }} - {{ $mother->identity_number }}</option>
                            @endforeach
                        </select>
                         @error('mother_id')
