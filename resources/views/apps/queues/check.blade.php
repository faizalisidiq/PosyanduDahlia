    ...
    @else
        <form action="{{ route('queues.public.store') }}" method="POST" id="queueForm">
            ...
            <div class="mb-4 flex items-center justify-between bg-teal-50 p-3 rounded-lg border border-teal-100">
                <div class="flex items-center">
                    ...
                    <label for="selectAll" class="ml-2 text-base font-medium text-teal-800 cursor-pointer">Pilih Semua
                        Anak</label>
                </div>
                <span class="text-sm text-teal-600 font-medium">Bisa pilih lebih dari satu</span>
            </div>
        ...
        <div class="mt-6 text-center border-t border-gray-100 pt-4">
            <a href="{{ route('queues.public.index') }}"
                class="text-base text-gray-500 hover:text-teal-600 transition-colors">Gunakan NIK Lain</a>
        </div>
    @endif
@endsection
